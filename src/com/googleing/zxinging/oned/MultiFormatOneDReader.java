...
package com.googleing.zxinging.oned;
...
import com.googleing.zxinging.common.BitArray;
...
public final class MultiFormatOneDReader extends OneDReader {
	...
	public MultiFormatOneDReader(Hashtable hints) {
		...
		if (possibleFormats != null) {
			if (possibleFormats.contains(BarcodeFormat.EAN_13) || possibleFormats.contains(BarcodeFormat.UPC_A) || possibleFormats.contains(BarcodeFormat.EAN_8)
